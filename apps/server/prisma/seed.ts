    ...
    await prisma.achievement.createMany({
        data: [
            ...
            },
            {
                ...
                icon: "Map",
                criterion: "1 trilha concluída",
                xpBonus: 400,
                status: "PUBLISHED",
            },
            {
                id: "a11",
                name: "Dev Consistente",
                description: "Mantenha uma streak de 3 dias",
                icon: "Flame",
                criterion: "Streak de 3",
                xpBonus: 70,
                status: "PUBLISHED",
            },
            {
            ...
            },
            {
                ...
                icon: "ShieldCheck",
                criterion: "10 acertos consecutivos",
                xpBonus: 120,
                status: "PUBLISHED",
            },
            {
            ...
            },
            {
                id: "a16",
                name: "Explorador",
                description: "Inicie 3 trilhas diferentes",
                icon: "Compass",
                criterion: "3 trilhas iniciadas",
                xpBonus: 150,
                status: "PUBLISHED",
            },
            {
                id: "a17",
                name: "Código Diário",
                description: "Estude por 30 dias no total",
                icon: "Clock",
                criterion: "30 dias estudados",
                xpBonus: 300,
                status: "PUBLISHED",
            },
            {
            ...
            },
            {
                ...
                description: "Complete sua primeira atividade prática",
                icon: "FolderCode",
                criterion: "1 atividade concluída",
                xpBonus: 120,
                status: "PUBLISHED",
            },
            {
